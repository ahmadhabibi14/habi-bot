  ...
  function Prev(){
	...
	return (
		<div className="flex flex-row justify-center w-full space-x-2 ">
			{/* PREVIOUS BUTTON*/}
			<button onClick={e => Prev()} className="rounded-lg py-2 px-4 bg-slate-300 hover:bg-emerald-500 hover:text-slate-50 font-bold">
				&lt;
			</button>
        ...
        {i}
			...
			{/* NEXT BUTTON */}
			<button onClick={e => Next()} className="rounded-lg py-2 px-4 bg-slate-300 hover:bg-emerald-500 hover:text-slate-50 font-bold">
				&gt;
			</button>
		</div>
	);
