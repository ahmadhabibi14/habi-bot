...
export const LaporLangsungIdGenerate = new Scenes.BaseScene<Scenes.SceneContext>("LaporLangsungIdGenerate")
export const LaporLangsungSpeedy = new Scenes.BaseScene<Scenes.SceneContext>("LaporLangsungSpeedy")
export const LaporLangsungNamaPelanggan = new Scenes.BaseScene<Scenes.SceneContext>("LaporLangsungNamaPelanggan")
export const LaporLangsungCpPelanggan = new Scenes.BaseScene<Scenes.SceneContext>("LaporLangsungCpPelanggan")
export const LaporLangsungPerbaikan = new Scenes.BaseScene<Scenes.SceneContext>("LaporLangsungPerbaikan")
