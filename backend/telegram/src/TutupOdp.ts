...
export const TutupODPIdGenerate = new Scenes.BaseScene<Scenes.SceneContext>(
  "TutupODPIdGenerate"
);
export const TutupODPNamaOdp = new Scenes.BaseScene<Scenes.SceneContext>(
  "TutupODPNamaOdp"
);
export const TutupODPAlamatOdp = new Scenes.BaseScene<Scenes.SceneContext>(
  "TutupODPAlamatOdp"
);
...
TutupODPAlamatOdp.on("text", (ctx) => {
  ...
  ctx.reply(
    "sumary\n" +
      "Id generate : " +
      TutupODPProperties.id_generate +
      "\n" +
      "Nama ODP : " +
      TutupODPProperties.nama_odp +
      "\n" +
      "Alamat ODP : " +
      TutupODPProperties.alamat_odp +
      "\n" +
