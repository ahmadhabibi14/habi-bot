...
export const TiketRegularInsiden = new Scenes.BaseScene<Scenes.SceneContext>(
  "TiketRegularInsiden"
);
export const TiketRegularSpeedy = new Scenes.BaseScene<Scenes.SceneContext>(
  "TiketRegularSpeedy"
);
export const TiketRegularNamaPelanggan =
  new Scenes.BaseScene<Scenes.SceneContext>("TiketRegularNamaPelanggan");
export const TiketRegularPerbaikan = new Scenes.BaseScene<Scenes.SceneContext>(
...
TiketRegularPerbaikan.on("text", (ctx) => {
  ...
  if (TiketRegularProperties != undefined) {
    ctx.reply(
      "sumary\n" +
        "No IN : " +
        TiketRegularProperties.no_insiden +
        "\n" +
        "No speedy : " +
        TiketRegularProperties.no_speedy +
        "\n" +
        "Nama pelanggan : " +
        TiketRegularProperties.nama_pelanggan +
        "\n" +
        "Perbaikan : " +
        TiketRegularProperties.perbaikan +
        "\n" +
